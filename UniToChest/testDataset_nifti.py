...
csv_file      = '/NAS/shared_data/for_VNLST/ft42/ct_public/unitochest/unitochest/test/test_dataset.csv'
# Base directories
base_ct_dir   = '/NAS/shared_data/for_VNLST/ft42/ct_public/unitochest/unitochest/test/images'
base_mask_dir = '/NAS/shared_data/for_VNLST/ft42/ct_public/unitochest/unitochest/test/masks'
